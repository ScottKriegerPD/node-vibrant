...
(function() {
  ...
  module.exports = Vibrant = (function() {
    ...
    Vibrant.prototype._process = function(image, opts) {
      ...
      this.generateColorFamily();
      return image.removeCanvas();
    };

    Vibrant.prototype.generateColorFamily = function() {
      if (this.DarkVibrantSwatch) {
        this.DarkVibrantSwatch.getColorFamily();
      }
      if (this.VibrantSwatch) {
        this.VibrantSwatch.getColorFamily();
      }
      if (this.LightVibrantSwatch) {
        this.LightVibrantSwatch.getColorFamily();
      }
      if (this.MutedSwatch) {
        this.MutedSwatch.getColorFamily();
      }
      if (this.LightMutedSwatch) {
        this.LightMutedSwatch.getColorFamily();
      }
      if (this.DarkMutedSwatch) {
        return this.DarkMutedSwatch.getColorFamily();
      }
    };
