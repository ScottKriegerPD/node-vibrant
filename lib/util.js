(function() {
  module.exports = {
    ...
    getColorFamilyHue: function(hue) {
      var base_hue, base_hues, differenceArray, i, index, len, lowest, name, ref;
      base_hues = [["#FF0000", 0], ["#FF7F00", 30], ["#FFFF00", 60], ["#7FFF00", 90], ["#00FF00", 120], ["#00FF7F", 150], ["#00FFFF", 180], ["#007FFF", 210], ["#0000FF", 240], ["#7F00FF", 270], ["#FF00FF", 300], ["#FF007F", 330]];
      differenceArray = [];
      Array.min = function(array) {
        return Math.min.apply(Math, array);
      };
      for (i = 0, len = base_hues.length; i < len; i++) {
        ref = base_hues[i], name = ref[0], base_hue = ref[1];
